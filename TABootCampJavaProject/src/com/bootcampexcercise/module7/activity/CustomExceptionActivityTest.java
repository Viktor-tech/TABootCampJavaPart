...
public class CustomExceptionActivityTest {
    ...
    public static void main(String[] args) throws CustomExceptionActivity {
        CustomExceptionActivityTest exceptionActivity = new CustomExceptionActivityTest();

        exceptionActivity.validateUser("Jane");
        exceptionActivity.validateUser("Dave");
        exceptionActivity.validateUser("George");
        exceptionActivity.validateUser("Tom");
